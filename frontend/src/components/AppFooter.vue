<template>
  <v-footer color="#000000" class="text-center d-flex flex-column ga-2 py-4">
    ...
    <div>
        <span class="d-none d-sm-inline-block">Demo Store</span>  &copy; 2022-{{ (new Date()).getFullYear() }} 
    </div>
