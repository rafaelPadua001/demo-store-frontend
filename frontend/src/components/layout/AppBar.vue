<template>
  <v-container>
    <v-app-bar color="#000000" density="comfortable" flat>
      <!-- Nav icon à esquerda -->
      ...
      <div class="d-flex align-center ml-0">
        ...
        <span v-else class="mr-2">Demo Store</span>
    ...
    <v-navigation-drawer v-model="drawer" class="bg-black" theme="dark" temporary>
      <v-list dense>
        <v-list-item>
