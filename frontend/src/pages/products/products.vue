    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: "Image", key: "thumbnail_path", sortable: false, width: "50px", align: 'start'},
                { title: "Product Name", key: "name", width: "150px", align: 'start'},
                // { title: "Product Description", key: "description", width: "150px" },
                { title: "Category", key: "category", width: "150px", align: 'start'},
                { title: "Price", key: "price", width: "150px", align: "start"},
                // { title: "Quantity", key: "quantity", width: "120px", align: "right" },
                //  { title: "Weight", key: "weight", width: "120px", align: "right" },
                { title: "Actions", key: "actions", width: "90px", align: "start", sortable: false },
            ],
        };
    },
    computed: {
