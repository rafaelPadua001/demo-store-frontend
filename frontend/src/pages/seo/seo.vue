    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: "PageId", key: "route", align: "start" },
                { title: "Meta Title", key: "metaTitle", align: "start" },
                { title: "Meta Description", key: "metaDescription", align: "start" },
                { title: "Meta Keywords", key: "metaKeywords", align: "start"},
                //{ title: "OG Title", key: "ogTitle" },
               // { title: "OG Description", key: "ogDescription" },
                { title: "OG Image", key: "ogImage", align: "start", width: '150px'},
               // { title: "Title", key: "title" },
                //{ title: "Content", key: "content", align: "right" },
                { title: "Actions", key: "actions", width: "100px", align: "start", sortable: false },
            ],
