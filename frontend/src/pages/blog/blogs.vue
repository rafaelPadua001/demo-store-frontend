    ...
    data() {
        return {
            ...
            headers: [
                ...
                { title: "Título", key: "title", align: "start", width: '150px'},
                { title: "Slug", key: "slug", align: "start", width: '150px' },
                { title: "Resumo", key: "excerpt", align: 'start', width: '250px'},
                { title: "Imagem de Capa", key: "cover_image", sortable: false, align: "start", width: "150px" },
                { title: "Criado em", key: "created_at", align: "start" },
                { title: "Atualizado em", key: "updated_at", align: "start"},
                { title: "Ações", key: "actions", sortable: false, align: "start", width: "100px" },
            ],
        };
    },
    computed: {
